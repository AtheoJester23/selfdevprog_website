        ...
        <div className="h-screen w-full flex items-center sm:pt-[65px]">
            <form className="bg-white w-full m-5 p-5 rounded-xl h flex flex-col gap-5">
                ...
                <div className="flex justify-end">
                    <button type="button" className="border border-gray-500 rounded py-2 px-5 -translate-y-1 hover:translate-none cursor-pointer duration-200 font-bold shadow-sm hover:shadow-none">Done</button>
                </div>
            </form>
        </div> 
    );
